...
def domain2():
  ...
  (:action play_play
         ...
         (AND (played1 play ?time)
           ...
           (WHEN (istime n10) (AND (istime n11) (NOT (istime n10))))
           (WHEN (istime n11) (AND (istime n12) (NOT (istime n11))))
           (WHEN (istime n12) (AND (istime n13) (NOT (istime n12))))
           (WHEN (istime n13) (AND (istime n14) (NOT (istime n13))))
           (WHEN (istime n14) (AND (istime n15) (NOT (istime n14))))
           (WHEN (istime n15) (AND (istime n16) (NOT (istime n15))))
              )
              )
  (:action play_play_copy
         ...
         :precondition (AND (istime_copy ?time) (inhand1_copy ?coloura ?numa ?time)
                            (inhand2_copy ?colourb ?numb ?time) (played2 play ?time))
         :effect
         (AND (played1_copy play ?time)
           ...
           (WHEN (istime_copy n10) (AND (istime_copy n11) (NOT (istime_copy n10))))
           (WHEN (istime_copy n11) (AND (istime_copy n12) (NOT (istime_copy n11))))
           (WHEN (istime_copy n12) (AND (istime_copy n13) (NOT (istime_copy n12))))
           (WHEN (istime_copy n13) (AND (istime_copy n14) (NOT (istime_copy n13))))
           (WHEN (istime_copy n14) (AND (istime_copy n15) (NOT (istime_copy n14))))
           (WHEN (istime_copy n15) (AND (istime_copy n16) (NOT (istime_copy n15))))
              )
  )
...
;           (WHEN (AND (playable ?coloura ?numa)(tokens1 n1) (inhand1 ?coloura n1 ?time))
      ...
      (:action discard_discard_copy
         :parameters (?time - number)
         :precondition (AND (istime_copy ?time) (played2 discard ?time))
         :effect
         (AND (played1_copy discard ?time)
           (played2_copy discard ?time)
           (WHEN (tokens1_copy n0) (AND (tokens1_copy n1)(NOT (tokens1_copy n0))))
